def generate_dalle3_prompts(user_text):
    base_prompts = [
        ...
        "Generate an AI image with DALL-E 3 depicting a hyperrealistic scene featuring an arrangement of raspberries laid out on a modern glass table. Each raspberry should be rendered with meticulous detail, capturing its plumpness, vibrant red color, and delicate texture. The raspberries should be arranged in a visually appealing composition on the sleek surface of the glass table. The table itself should exhibit modern design characteristics, with clean lines and minimalistic aesthetics. Overlaying this arrangement, introduce glowing metallic-textured blue letters spelling out the word '{}'. Ensure the text appears to float elegantly above the raspberries and glass table, emitting a soft, ethereal glow that enhances the modern elegance of the scene. Pay close attention to the reflections and refractions on the glass surface, as well as the intricate details of each raspberry, to achieve a visually stunning and photorealistic rendering."
    ]
